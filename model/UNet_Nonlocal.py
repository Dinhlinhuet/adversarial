...
class contraction_path(nn.Module):
    def __init__(self, in_ch, out_ch):
        ...
        self.non_local= NONLocalBlock2D(in_channels=out_ch, sub_sample=False)
...
class UNetNonlocal(nn.Module):
    ...
    #defense : use for train with defense mode, opposite with train combine
    def forward(self, x):
        # print('input', x.size())
