...
reference from https://github.com/bfortuner/pytorch_tiramisu
...
class DenseNetNonlocal(nn.Module):
    def __init__(self, in_channels=1, down_blocks=(4,5,7,10,12),
        ...
        for i in range(len(down_blocks)):
            ...
            non_lb_blk = NONLocalBlock2D(in_channels=cur_channels_count, sub_sample=False)
