...
from ._deeplab_nonlocal import DeepLabHead, DeepLabHeadV3PlusNonlocal, DeepLabV3
...
def _segm_hrnet(name, backbone_name, num_classes, pretrained_backbone):
    ...
    if name=='deeplabv3plus':
        ...
        classifier = DeepLabHeadV3PlusNonlocal(inplanes, low_level_planes, num_classes, aspp_dilate)
    elif name=='deeplabv3':
...
def _segm_resnet(name, backbone_name, num_classes, in_channels, output_stride, pretrained_backbone):
...
def _segm_mobilenet(name,backbone_name, num_classes, in_channels, output_stride, pretrained_backbone):
    if output_stride==8:
        aspp_dilate = [12, 24, 36]
    else:
        aspp_dilate = [6, 12, 18]
...
def _load_model(arch_type, backbone, num_classes, in_channels, output_stride, pretrained_backbone):
    print('backbone', backbone)
    if backbone=='mobilenetv2':
        model = _segm_mobilenet(arch_type, backbone, num_classes,  in_channels=in_channels, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
    elif backbone.startswith('resnet'):
        model = _segm_resnet(arch_type, backbone, num_classes, in_channels=in_channels, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
...
def deeplabv3_resnet101(num_classes=21, in_channels=3, output_stride=8, pretrained_backbone=True):
    ...
    Args:
        ...
        pretrained_backbone (bool): If True, use the pretrained backbone.
    """
    return _load_model('deeplabv3', 'resnet101', num_classes, in_channels=in_channels, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
...
def deeplabv3plus_resnet101(num_classes=21, in_channels=3, output_stride=8, pretrained_backbone=True):
    """Constructs a DeepLabV3+ model with a ResNet-101 backbone.
    ...
    Args:
        ...
        pretrained_backbone (bool): If True, use the pretrained backbone.
    """
    return _load_model('deeplabv3plus', 'resnet101', num_classes,in_channels=in_channels, output_stride=output_stride,
                       pretrained_backbone=pretrained_backbone)


def deeplabv3plus_mobilenet(num_classes=21,in_channels=3, output_stride=8, pretrained_backbone=True):
    """Constructs a DeepLabV3+ model with a MobileNetv2 backbone.
    ...
    Args:
        ...
        pretrained_backbone (bool): If True, use the pretrained backbone.
    """
    return _load_model('deeplabv3plus', 'mobilenetv2', num_classes,in_channels=in_channels, output_stride=output_stride,
                       pretrained_backbone=pretrained_backbone)