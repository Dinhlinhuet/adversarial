...
train_dataset = SampleDataset(data_path, n_class, 3, 'train','UNet','ifgsm','1','org', args.img_size, args.img_size)
val_dataset = SampleDataset(data_path, n_class,3, 'val', 'UNet','ifgsm','1', 'org', args.img_size, args.img_size)
