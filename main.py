...
train_dataset = SampleDataset(data_path, n_class, 3, 'train',None,None,None,'org', args.img_size, args.img_size)
val_dataset = SampleDataset(data_path, n_class,3, 'val', None, None, None, 'org', args.img_size, args.img_size)
...
for epoch in range(start_epoch,num_epochs+start_epoch):
    ...
    for i, (images, masks) in enumerate(train_loader):
        ...
        out, side_5, side_6, side_7, side_8 = model(images*255)
