...
#python tools/defense_hgd.py --model_path ./checkpoints/ --mode test --data_path octafull --output_path \
#./output/test/denoise/ --denoise_output ./output/test/denoised_imgs/ --model SegNet --classes 3 --channels 1 \
#--adv_model SegNet --attacks dag --target 1 --mask_type 1
#python tools/defense_hgd.py --model_path ./checkpoints/ --mode test --data_path octafull --output_path \
#./output/test/denoise/ --denoise_output ./output/test/denoised_imgs/ --model SegNet --classes 3 --channels 1 \
#--adv_model UNet --attacks dag --target 1 --mask_type 1
#python tools/defense_hgd.py --model_path ./checkpoints/ --mode test --data_path octafull --output_path \
#./output/test/denoise/ --denoise_output ./output/test/denoised_imgs/ --model SegNet --classes 3 --channels 1 \
#--adv_model DenseNet --attacks dag --data_type DAG_A --target 1 --mask_type 1

#python tools/defense_hgd.py --model_path ./checkpoints/ --mode test --data_path octafull --output_path \
#./output/test/denoise/ --denoise_output ./output/test/denoised_imgs/ --model SegNet --classes 3 --channels 1 \
#--adv_model SegNet --attacks dag --target 2
#python tools/defense_hgd.py --model_path ./checkpoints/ --mode test --data_path octafull --output_path \
#./output/test/denoise/ --denoise_output ./output/test/denoised_imgs/ --model SegNet --classes 3 --channels 1 \
#--adv_model UNet --attacks dag --target 2
#python tools/defense_hgd.py --model_path ./checkpoints/ --mode test --data_path octafull --output_path \
#./output/test/denoise/ --denoise_output ./output/test/denoised_imgs/ --model SegNet --classes 3 --channels 1 \
#--adv_model DenseNet --attacks dag --target 2
...
#python tools/defense_hgd.py --model_path ./checkpoints/ --mode test --data_path octafull --output_path \
#./output/test/denoise/ --denoise_output ./output/test/denoised_imgs/ --model UNet --classes 3 --channels 1 \
#--adv_model DenseNet --attacks dag --target 1 --mask_type 1

#python tools/defense_hgd.py --model_path ./checkpoints/ --mode test --data_path octafull --output_path \
#./output/test/denoise/ --denoise_output ./output/test/denoised_imgs/ --model UNet --classes 3 --channels 1 \
#--adv_model SegNet --attacks dag  --target 0 --mask_type 2
#python tools/defense_hgd.py --model_path ./checkpoints/ --mode test --data_path octafull --output_path \
#./output/test/denoise/ --denoise_output ./output/test/denoised_imgs/ --model UNet --classes 3 --channels 1 \
#--adv_model UNet --attacks dag --data_type DAG_B --target 0 --mask_type 2
#python tools/defense_hgd.py --model_path ./checkpoints/ --mode test --data_path octafull --output_path \
#./output/test/denoise/ --denoise_output ./output/test/denoised_imgs/ --model UNet --classes 3 --channels 1 \
#--adv_model DenseNet --attacks dag  --target 0 --mask_type 2
