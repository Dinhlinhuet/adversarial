...
python defense.py --model_path ./checkpoints/ --mode test --data_path fundus --output_path \
./output/test/denoise/ --denoise_output ./output/test/denoised_imgs/ --model SegNet --classes 3 \
--adv_model SegNet --attacks ifgsm --target r --mask_type 2
python defense.py --model_path ./checkpoints/ --mode test --data_path fundus --output_path \
./output/test/denoise/ --denoise_output ./output/test/denoised_imgs/ --model SegNet --classes 3 \
--adv_model UNet --attacks ifgsm --target r --mask_type 2
python defense.py --model_path ./checkpoints/ --mode test --data_path fundus --output_path \
./output/test/denoise/ --denoise_output ./output/test/denoised_imgs/ --model SegNet --classes 3 \
--adv_model DenseNet --attacks ifgsm --target r --mask_type 2
python defense.py --model_path ./checkpoints/ --mode test --data_path fundus --output_path \
./output/test/denoise/ --denoise_output ./output/test/denoised_imgs/ --model SegNet --classes 3 \
--adv_model AgNet --attacks ifgsm --target r --mask_type 2
#---------------------
python defense.py --model_path ./checkpoints/ --mode test --data_path fundus --output_path \
